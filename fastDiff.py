...
def case3():
  ...
  a=fig.add_subplot(232)
  f = dtdy
  b=plt.imshow((255*f/f.max()).astype(float),interpolation='nearest',cmap='gray')
  a.set_title('After')

  a=fig.add_subplot(233)
  f = dtdy1
  plt.imshow((255*f/f.max()).astype(float),interpolation='nearest',cmap='gray')
  a.set_title('After: axis 0')
